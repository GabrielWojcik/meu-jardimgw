...
function VasosContent() {
  ...
  const filteredProducts = category
    ? potMocks.filter((product) => product.category === category)
    : potMocks;
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800">Nossos Vasos</h1>
          <p className="text-lg text-gray-600 mt-2">
            Cachepôs e vasos em cerâmica, cimento, barro e fibra para combinar
            com cada planta.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Peças selecionadas em cerâmica, cimento, barro e fibra, feitas
                para durar por muitos anos.
              </p>
            </div>
            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm">
              <div className="bg-lime-100 p-4 rounded-full mb-4">
              ...
              <p className="text-gray-600">
                Cada vaso segue com embalagem reforçada para chegar sem trincas
                nem lascas.
              </p>
            </div>
            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Medidas e drenagem descritas em cada produto para você escolher
                o vaso ideal.
              </p>
            </div>
          </div>
...
export default function VasosPage() {
  return (
    <Suspense
      fallback={
